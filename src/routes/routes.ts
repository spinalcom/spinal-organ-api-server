...
function routes(
  ...
  require('./contexts/contextNodeTypeListOfNode')(
    logger,
    app,
    spinalAPIMiddleware
  );
  ...
  require('./categoriesAttributs/readCategoriesByNameMultiple')(
    logger,
    app,
    spinalAPIMiddleware
  );
  ...
  require('./geographicContext/room/roomInventory')(
    logger,
    app,
    spinalAPIMiddleware
  );
  ...
  require('./geographicContext/floor/readStaticDetails')(
    logger,
    app,
    spinalAPIMiddleware
  );
  ...
  require('./roomGroup/room/deleteRoomFromGroup')(
    logger,
    app,
    spinalAPIMiddleware
  );
  ...
  // endpoint
  require('./endpointGroup/endpoint/endpointList')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./endpointGroup/endpoint/addEndPointList')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./endpointGroup/endpoint/deleteEndPointList')(
    logger,
    app,
    spinalAPIMiddleware
  );
  ...
  // equipement
  require('./equipementGroup/equipement/equipementList')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./equipementGroup/equipement/addEquipementList')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./equipementGroup/equipement/deleteEquipementFromGroup')(
    logger,
    app,
    spinalAPIMiddleware
  );
  ...
  require('./analysis/organs/manageOrganAssignments')(
    logger,
    app,
    spinalAPIMiddleware
  );
  ...
  require('./userGroup/user/deleteUserInGroup')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./userGroup/user/getUserInGroup')(logger, app, spinalAPIMiddleware);
  require('./userGroup/user/moveUsersInGroup')(
    logger,
    app,
    spinalAPIMiddleware
  );

  require('./organization/context/createOrganizationContext')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/context/getOrganizationContextById')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/context/getOrganizationContext')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/context/updateOrganizationContext')(
    logger,
    app,
    spinalAPIMiddleware
  );

  require('./organization/organization/createOrganization')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/organization/getOrganizationById')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/organization/getOrganizationFromContext')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/organization/getOrganizationParents')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/organization/deleteOrganization')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/organization/getOrganizationContextParents')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/organization/getOrganizationFromOrganization')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/organization/updateOrganizations')(
    logger,
    app,
    spinalAPIMiddleware
  );

  require('./organization/userGroup/addUserGroupFromOrganization')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/userGroup/deleteUserGroupFromOrganization')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/userGroup/getUserGroupFromOrganization')(
    logger,
    app,
    spinalAPIMiddleware
  );

  require('./organization/roomGroup/addRoomGroupFromOrganization')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/roomGroup/deleteRoomGroupFromOrganization')(
    logger,
    app,
    spinalAPIMiddleware
  );
  require('./organization/roomGroup/getRoomGroupsFromOrganization')(
    logger,
    app,
    spinalAPIMiddleware
  );
