...
module.exports = function (logger: any, app: Express, spinalAPIMiddleware: ISpinalAPIMiddleware) {
	 ...
	 *         name: unlink
	 *         required: false
	 *         description: If set to true or 1, unlink all references to the file after removing it from the context.
	 *         schema:
	 *           type: boolean
	 *       - in: query
	 *         name: remove_children
	 *         required: false
	 *         description: If set to true or 1, remove the file children while removing it from the context.
	 *         schema:
	 *           type: boolean
	 *
	 *     responses:
	 *       200:
	 *         description: File removed from context successfully.
	 *       400:
	 *         description: Invalid context/document id, context/document not found, or operation failed.
	 *       500:
