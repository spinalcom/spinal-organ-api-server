module.exports = [
  ...
  "../src/routes/geographicContext/building/buildingInventory.ts",
  ...
  "../src/routes/interface/BasicNodeExtended.ts",
  ...
  "../src/routes/interface/IOrganization.ts",
  "../src/routes/interface/IUser.ts",
  "../src/routes/interface/IUserGroup.ts",
  ...
  "../src/routes/organization/context/createOrganizationContext.ts",
  "../src/routes/organization/context/getOrganizationContext.ts",
  "../src/routes/organization/context/getOrganizationContextById.ts",
  "../src/routes/organization/context/updateOrganizationContext.ts",
  "../src/routes/organization/organization/createOrganization.ts",
  "../src/routes/organization/organization/deleteOrganization.ts",
  "../src/routes/organization/organization/getOrganizationById.ts",
  "../src/routes/organization/organization/getOrganizationContextParents.ts",
  "../src/routes/organization/organization/getOrganizationFromContext.ts",
  "../src/routes/organization/organization/getOrganizationFromOrganization.ts",
  "../src/routes/organization/organization/getOrganizationParents.ts",
  "../src/routes/organization/organization/updateOrganizations.ts",
  "../src/routes/organization/roomGroup/addRoomGroupFromOrganization.ts",
  "../src/routes/organization/roomGroup/deleteRoomGroupFromOrganization.ts",
  "../src/routes/organization/roomGroup/getRoomGroupsFromOrganization.ts",
  "../src/routes/organization/userGroup/addUserGroupFromOrganization.ts",
  "../src/routes/organization/userGroup/deleteUserGroupFromOrganization.ts",
  "../src/routes/organization/userGroup/getUserGroupFromOrganization.ts",
  "../src/routes/routes.ts",
  "../src/routes/user/context/createUserContext.ts",
  "../src/routes/user/context/getUserContext.ts",
  "../src/routes/user/context/getUserContextById.ts",
  "../src/routes/user/context/updateUserContext.ts",
  "../src/routes/user/user/createUser.ts",
  "../src/routes/user/user/deleteUser.ts",
  "../src/routes/user/user/getUser.ts",
  "../src/routes/user/user/getUserById.ts",
  "../src/routes/user/user/getUserMultiple.ts",
  "../src/routes/user/user/getUserTickets.ts",
  "../src/routes/user/user/updateUser.ts",
  "../src/routes/userGroup/category/createUserCategoryGroup.ts",
  "../src/routes/userGroup/category/deleteUserCategoryGroup.ts",
  "../src/routes/userGroup/category/getUserCategoryGroup.ts",
  "../src/routes/userGroup/category/getUserCategoryGroupById.ts",
  "../src/routes/userGroup/category/updateUserCategoryGroup.ts",
  "../src/routes/userGroup/context/createUserGroupContext.ts",
  "../src/routes/userGroup/context/deleteUserGroupContext.ts",
  "../src/routes/userGroup/context/getUserGroupContext.ts",
  "../src/routes/userGroup/context/getUserGroupContextById.ts",
  "../src/routes/userGroup/context/updateUserGroupContext.ts",
