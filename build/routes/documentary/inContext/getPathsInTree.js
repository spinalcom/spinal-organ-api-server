...
module.exports = function (logger, app, spinalAPIMiddleware) {
    /**
     * @swagger
     * /api/v1/documentary/file/paths_in_tree/{startNodeId}:
     *   get:
     *     security:
     *       - bearerAuth:
     *           - readOnly
     *     summary: Get paths in tree
     *     description: Returns all paths found in a tree starting from the provided node.
     *     tags:
     *       - Documentary
     *     parameters:
     *       - in: path
     ...
     */
    app.get("/api/v1/documentary/file/paths_in_tree/:startNodeId", async (req, res, next) => {
        try {
            ...
            const data = await spinal_env_viewer_plugin_documentation_service_1.serviceDocumentation.getAllPathsInTree(node);
...
//# sourceMappingURL=getPathsInTree.js.map