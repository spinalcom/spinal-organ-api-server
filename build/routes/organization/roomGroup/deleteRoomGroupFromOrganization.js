...
module.exports = function (logger, app, spinalAPIMiddleware) {
     ...
     *           format: int64
     *           minimum: 1
     *           description: ID of the organization to remove the room group from
     *       - in: path
     *         name: roomGroupId
     *         required: true
     *         schema:
     ...
     *           format: int64
     *           minimum: 1
     *           description: ID of the room group to remove
     *     responses:
     *       204:
     *         description: Room group removed successfully
     *       400:
     ...
     */
    app.delete('/api/v1/organization/context/:contextId/organization/:organizationId/room-group/:roomGroupId', (0, express_zod_safe_1.default)({
        params: zod_1.z.strictObject({
            contextId: zod_1.z.coerce.number().positive(),
            organizationId: zod_1.z.coerce.number().positive(),
            roomGroupId: zod_1.z.coerce.number().positive(),
        }),
    }), async (req, res) => {
        try {
            ...
            const { contextId, organizationId, roomGroupId } = req.params;
            ...
            try {
                ...
                const roomGroupNode = await (0, loadAndValidateNode_1.loadAndValidateNode)(spinalAPIMiddleware, roomGroupId, profileId, spinal_model_user_service_1.SPINAL_ROOM_GROUP_TYPE);
                await (0, spinal_model_user_service_1.removegeographicRoomGroupFromOrganization)(roomGroupNode, organizationNode);
                res.sendStatus(204);
            }
            catch (error) {
...
//# sourceMappingURL=deleteRoomGroupFromOrganization.js.map