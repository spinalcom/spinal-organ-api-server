...
module.exports = function (logger, app, spinalAPIMiddleware) {
     ...
     *       - bearerAuth:
     *         - read
     *     summary: Get the direct context parents organization of an Organization
     *     description: Retrieve the context parent organization of a specific Organization by its ID
     *     tags:
     *       - Organization
     *     parameters:
     *       - in: path
     ...
     *           format: int64
     *           minimum: 1
     *           description: ID of the organization to retrieve the context parent organization from
     *     responses:
     *       200:
     *         description: Context parents organization retrieved successfully
     *         content:
     *           application/json:
     *             schema:
     *               type: array
     ...
     */
    app.get('/api/v1/organization/:organizationId/parent/context', (0, express_zod_safe_1.default)({
        ...
        try {
            ...
            try {
                ...
                const parentOrganizations = await (0, spinal_model_user_service_1.getParentOrganizationContextFromOrganization)(organization);
...
//# sourceMappingURL=getOrganizationContextParents.js.map