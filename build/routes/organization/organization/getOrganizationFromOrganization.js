    ...
    app.get('/api/v1/organization/context/:contextId/organization/:organizationId', (0, express_zod_safe_1.default)({
        ...
        try {
            ...
            try {
                ...
                const organizationParent = await (0, loadAndValidateNode_1.loadAndValidateNode)(spinalAPIMiddleware, organizationId, spinal_model_user_service_1.SPINAL_ORGANIZATION_TYPE);
                if (!organizationParent)
                    throw {
                        code: 404,
                        message: `No organization found with the ID ${organizationId}`,
                    };
                if (name) {
