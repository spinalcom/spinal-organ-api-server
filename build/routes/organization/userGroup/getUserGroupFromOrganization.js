...
module.exports = function (logger, app, spinalAPIMiddleware) {
     ...
     */
    app.get('/api/v1/organization/context/:contextId/organization/:organizationId/user-group', (0, express_zod_safe_1.default)({
        ...
        try {
            ...
            try {
                ...
                const userGroup = await (0, spinal_model_user_service_1.getSpinalUserGroupFromOrganization)(organizationParent, organizationContext);
                if (!userGroup) {
                    throw {
                        code: 404,
                    ...
                    const results = await (0, createBasicNode_1.createBasicNodeSync)(userGroup, [
                        'color',
                    ]);
...
//# sourceMappingURL=getUserGroupFromOrganization.js.map