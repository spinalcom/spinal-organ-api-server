...
module.exports = function (logger, app, spinalAPIMiddleware) {
    ...
    app.put('/api/v1/ticket/:ticketId/change_workflow', async (req, res) => {
        try {
            ...
            const [newContextTicketNode, newProcessNode, ticketNode] = await Promise.all([
            ...
            await (0, spinal_service_ticket_1.changeTicketProcess)(ticketNode, newProcessNode, newContextTicketNode);
            return res.json();
        }
        catch (error) {
