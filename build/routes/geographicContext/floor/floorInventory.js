...
const getFloorInventory_1 = require("../../../utilities/getFloorInventory");
module.exports = function (logger, app, spinalAPIMiddleware) {
    ...
    app.post("/api/v1/floor/:id/inventory", async (req, res, next) => {
        try {
            ...
            const inventory = await (0, getFloorInventory_1.getFloorInventory)(spinalAPIMiddleware, profileId, groupContext, parseInt(req.params.id, 10), reqInfo);
