...
module.exports = function (logger, app, spinalAPIMiddleware) {
   ...
   *       - bearerAuth:
   *         - readOnly
   *     description: read static details of a floor
   *     summary: Gets static details of a floor
   *     tags:
   *       - Geographic Context
   *     parameters:
   *      - in: path
    ...
    */
    app.get("/api/v1/floor/:id/read_static_details", async (req, res, next) => {
        try {
            ...
            const info = await (0, getStaticDetailsInfo_1.getFloorStaticDetailsInfo)(spinalAPIMiddleware, profileId, parseInt(req.params.id, 10));
