    ...
    */
    app.post("/api/v1/room/equipment_list_multiple", async (req, res, next) => {
        try {
            ...
            const promises = ids.map(id => (0, getEquipmentListInfo_1.getEquipmentListInfo)(spinalAPIMiddleware, profileId, id));
...
//# sourceMappingURL=roomEquipementListMultiple.js.map