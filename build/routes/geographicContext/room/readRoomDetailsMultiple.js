...
module.exports = function (logger, app, spinalAPIMiddleware) {
    ...
    app.post('/api/v1/room/read_details_multiple', async (req, res, next) => {
        try {
            ...
            const promises = ids.map(id => (0, getRoomDetailsInfo_1.getRoomDetailsInfo)(spinalAPIMiddleware, profileId, id).then(details => ({ dynamicId: id, ...details })));
            ...
            return res
                .status(400)
                .send(error.message || 'An error occurred while fetching room details.');
        }
    });
};
//# sourceMappingURL=readRoomDetailsMultiple.js.map