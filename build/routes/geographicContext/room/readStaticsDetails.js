    ...
    app.get("/api/v1/room/:id/read_static_details", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (room.getType().get() === 'geographicRoom') {
                const [allNodesControlesEndpoints, equipements, CategorieAttributsList, groupParents,] = yield Promise.all([
...
function getRoomParent(room) {
    return __awaiter(this, void 0, void 0, function* () {
        let parents = yield spinal_env_viewer_graph_service_1.SpinalGraphService.getParents(room.getId().get(), [
            'hasGeographicRoom',
...
function getRoomAttributes(room) {
    return __awaiter(this, void 0, void 0, function* () {
        let categories = yield room.getChildren(constants_1.NODE_TO_CATEGORY_RELATION);
        const promises = categories.map((child) => __awaiter(this, void 0, void 0, function* () {
...
function getRoomBimObject(room) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        var revitFamily = '';
        var revitType = '';
        const promises = bimObjects.map((child) => __awaiter(this, void 0, void 0, function* () {
            // attributs BIMObject
...
function getNodeControlEndpoints(room) {
    return __awaiter(this, void 0, void 0, function* () {
        var profils = yield spinal_env_viewer_graph_service_1.SpinalGraphService.getChildren(room.getId().get(), [
        ...
        var promises = profils.map((profile) => __awaiter(this, void 0, void 0, function* () {
            var result = yield spinal_env_viewer_graph_service_1.SpinalGraphService.getChildren(profile.id.get(), [
