    ...
    */
    app.post('/api/v1/room/read_static_details_multiple', async (req, res, next) => {
        try {
            ...
            const promises = dynamicIds.map(dynamicId => (0, getRoomStaticDetailsInfo_1.getRoomStaticDetailsInfo)(spinalAPIMiddleware, profileId, dynamicId));
...
//# sourceMappingURL=readStaticsDetailsMultiple.js.map