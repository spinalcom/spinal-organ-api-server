   ...
   */
    app.post('/api/v1/room/reference_object_list_multiple', async (req, res, next) => {
        try {
            ...
            const promises = ids.map(id => (0, getRoomReferenceObjectListInfo_1.getRoomReferenceObjectsListInfo)(spinalAPIMiddleware, profileId, id));
...
//# sourceMappingURL=roomReferenceObjectsListMultiple.js.map