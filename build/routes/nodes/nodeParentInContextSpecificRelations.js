...
module.exports = function (logger, app, spinalAPIMiddleware) {
    ...
    app.post('/api/v1/context/:idContext/node/:idNode/parents', async (req, res) => {
        try {
            ...
            const parents = await (0, getParentNodesInfo_1.getParentNodesInfo)(spinalAPIMiddleware, profileId, parseInt(nodeId, 10), relations, parseInt(contextId, 10));
...
//# sourceMappingURL=nodeParentInContextSpecificRelations.js.map