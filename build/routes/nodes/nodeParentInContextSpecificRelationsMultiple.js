...
module.exports = function (logger, app, spinalAPIMiddleware) {
    /**
     * @swagger
     * /api/v1/context/{id}/node/parents_multiple:
     *   post:
     *     security:
     *       - bearerAuth:
     *         - readOnly
    ...
    app.post('/api/v1/context/:id/node/parents_multiple', async (req, res) => {
        try {
            ...
            const promises = nodes.map(async (node) => {
                const parents = await (0, getParentNodesInfo_1.getParentNodesInfo)(spinalAPIMiddleware, profileId, node.dynamicId, node.relations, parseInt(contextId, 10));
                return {
...
//# sourceMappingURL=nodeParentInContextSpecificRelationsMultiple.js.map