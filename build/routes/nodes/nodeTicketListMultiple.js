...
module.exports = function (logger, app, spinalAPIMiddleware) {
    ...
    app.post('/api/v1/node/ticket_list_multiple', async (req, res, next) => {
        try {
            ...
            const promises = ids.map((id) => (0, getTicketListInfo_1.getTicketListInfo)(spinalAPIMiddleware, profileId, id).then((tickets) => ({
                dynamicId: id,
                tickets,
            })));
...
//# sourceMappingURL=nodeTicketListMultiple.js.map