...
module.exports = function (logger, app, spinalAPIMiddleware) {
     ...
     */
    app.post('/api/v1/node/children_multiple', async (req, res) => {
        try {
            ...
            const promises = nodes.map(async (node) => {
                const children = await (0, getChildrenNodesInfo_1.getChildrenNodesInfo)(spinalAPIMiddleware, profileId, node.dynamicId, node.relations);
                return {
...
//# sourceMappingURL=nodeChildrenSpecificRelationsMultiple.js.map