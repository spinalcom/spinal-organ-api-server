...
module.exports = function (logger, app, spinalAPIMiddleware) {
    ...
    app.get("/api/v1/analysis/algorithms", async (req, res, next) => {
        try {
            ...
            const serialize = (a) => (0, spinal_model_analysis_1.localizeAlgorithm)(a, locale);
            const categorized = [
                ...
                ...spinal_model_analysis_1.EXCEL_ALGORITHMS,
            ];
            ...
            const data = {
                ...
                EXCEL: spinal_model_analysis_1.EXCEL_ALGORITHMS.map(serialize),
