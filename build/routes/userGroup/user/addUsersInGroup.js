...
module.exports = function (logger, app, spinalAPIMiddleware) {
    ...
    app.post('/api/v1/user-group/context/:contextId/group/:groupId/user', (0, express_zod_safe_1.default)({
        ...
        body: zod_1.z.strictObject({
            userDynamicIds: zod_1.z.array(zod_1.z.coerce.number().positive()).min(1),
        }),
    }), async (req, res) => {
        try {
            ...
            try {
                ...
                const results = { userSuccessfullyAdded: [], userFailedToAdd: [] };
                ...
                for (let i = 0; i < req.body.userDynamicIds.length; i += 25) {
                    ...
                    await Promise.all(batch.map(async (userId) => {
                        try {
                            ...
                            await (0, spinal_model_user_service_1.addSpinalUserToSpinalUserGroup)(userGroupContext, groupNode, userNode);
