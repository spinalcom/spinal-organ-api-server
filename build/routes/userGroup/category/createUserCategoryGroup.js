    ...
    app.post('/api/v1/user-group/context/:contextId/category', (0, express_zod_safe_1.default)({
        ...
        try {
            ...
            try {
                ...
                const userGroupCategory = await (0, spinal_model_user_service_1.createGroupingCategory)(userGroupContext, name, color);
                const result = await (0, createBasicNode_1.createBasicNodeSync)(userGroupCategory, [
                    'color',
                ]);
            ...
            return res
                .status(500)
                .send('An unexpected error occurred while creating the user group category');
        }
    });
};
//# sourceMappingURL=createUserCategoryGroup.js.map