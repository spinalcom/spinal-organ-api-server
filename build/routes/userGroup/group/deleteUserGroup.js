...
module.exports = function (logger, app, spinalAPIMiddleware) {
     ...
     */
    app.delete('/api/v1/user-group/group/:groupId', (0, express_zod_safe_1.default)({
        ...
        try {
            ...
            try {
                ...
                await (0, spinal_model_user_service_1.deleteSpinalUserGroup)(group);
                res.status(204).send();
            }
            catch (error) {
                throw {
...
//# sourceMappingURL=deleteUserGroup.js.map