...
module.exports = function (logger, app, spinalAPIMiddleware) {
     ...
     *     responses:
     *       200:
     *         description: Successfully retrieved the user group context
     *         content:
     *           application/json:
     *             schema:
     *               type: object
    ...
    app.get('/api/v1/user-group/context/:contextId', (0, express_zod_safe_1.default)({
        ...
        try {
            ...
            return res
                .status(500)
                .send('An unexpected error occurred while retrieving the user group context');
        }
    });
};
//# sourceMappingURL=getUserGroupContextById.js.map